...
router.post("/upload-avatar", authMiddleware.protect, authMiddleware.requireOnboarded, upload.single("avatar"), userController.uploadAvatar);
router.post("/upload-photo", authMiddleware.protect, authMiddleware.requireOnboarded, upload.single("photo"), userController.uploadPhoto);
router.delete("/delete-photo", authMiddleware.protect, authMiddleware.requireOnboarded, validate(deletePhotoSchema), userController.deletePhoto);
